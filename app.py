...
CORS(app, origins = ["http://localhost:3000", "https://cms-user.herokuapp.com/", "https://quiz-assignment-8e887.firebaseapp.com/"], allow_headers = ["Content-Type", "Authorization", "Access-Control-Allow-Credentials"], supports_credentials=True)
